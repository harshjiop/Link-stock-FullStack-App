...
export default function Links() {
  return (
      ...
      <div className="flex flex-col gap-6 w-full">
        {[1, 2, 3, 4, 5].map((index) => (
          <div key={index} className="flex justify-start gap-8 bg-white px-5 py-2 rounded-md">
            {/* icons */}
            ...
            <div>
                ...
                <Link className="font-semibold underline" to={'https://www.reddit.com/'}>https://www.reddit.com/</Link>
            </div>
          </div>
        ))}
      </div>
